    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tolak Surat Tugas</h5>
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="/arsiparis/surat-tugas">Surat Tugas</a></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4 mb-4">
                                            <a class="btn btn-primary" href="/arsiparis/surat-tugas">
                                    ...
                                    <div class="d-flex align-content-end w-100 justify-content-end" style="gap: 10px;">
                                        ...
                                        <form action="/arsiparis/surat-tugas"
                                            method="post">
                                            @csrf
                                            @method('POST')
