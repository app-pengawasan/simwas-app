...
@section('title', 'Detail Kendali Mutu')
...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form method="post" action="/arsiparis/kendali-mutu/{{ $surat->id }}">
...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Detail Kendali Mutu</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/arsiparis/dashboard">Dashboard</a></div>
                <div class="breadcrumb-item active"><a href="/arsiparis/kendali-mutu">Kendali Mutu</a></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4 mb-4">
                                            <a class="btn btn-primary" href="/arsiparis/kendali-mutu">
                                                <i class="fas fa-chevron-circle-left"></i> Kembali
                                            </a>
                                        </div>

                                        @include('components.timeline.timeline-km')
                                    ...
                                    <div class="d-flex align-content-end w-100 justify-content-end" style="gap: 10px;">
                                        ...
                                        <form action="/arsiparis/kendali-mutu"
                                            ...
                                            @csrf
                                            @method('POST')
                                            <input type="hidden" name="kendali_mutu" value="{{ $surat->id }}">
