            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Kepegawaian</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="/analis-sdm/master-data-kepegawaian" method="post">
                        <div class="modal-body">
                            @csrf  
                            <input type="hidden" name="is_aktif" value="1">
                            <div class="form-group">
                                <label for="jenis">Jenis Data Kepegawaian</label>
