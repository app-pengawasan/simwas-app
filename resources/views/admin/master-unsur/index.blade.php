...
<div class="main-content">
    <!-- Modal -->
    @include('admin.master-unsur.create');
    @include('admin.master-unsur.edit');
    <section class="section">
        <div class="section-header">
            <h1>Master Unsur Inspektorat Utama</h1>
        </div>
        <div class="row">
            <div class=" col-md-12">
                <div class="card">
                                    ...
                                    <tr id="index_{{ $unsur->id }}">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form action="{{ route('master-unsur.destroy', $unsur->id) }}" id="form-{{ $unsur->id }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" name="id" value="{{ $unsur->id }}">
                                                    <button type="button" data-id="{{ $unsur->id }}"
...
<script src="{{ asset('js') }}/page/admin/master-unsur.js"></script>
