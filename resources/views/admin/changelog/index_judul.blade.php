...
<div class="main-content">
    <!-- Modal -->
    @include('components.master-objek.form.create-judul-changelogs');
    @include('components.master-objek.form.edit-judul-changelogs');
    <section class="section">
        <div class="section-header">
            <h1>Versi Changelogs</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/admin">Dashboard</a></div>
                <div class="breadcrumb-item">Versi Changelogs</div>
            </div>
        </div>
        <div class="row">
            <div class=" col-md-12">
                        ...
                        <div class="d-flex justify-content-between flex-wrap my-2 mb-3" style="gap:10px">
                            ...
                            <div style="gap:10px" class="d-flex align-items-end">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#modal-create-judul-changelogs">
                        ...
                        <div class="">
                            <table id="changelogs"
                                ...
                                <tbody>
                                    ...
                                    <tr id="index_{{ $cl->id_judulchangelog }}">
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-warning edit-btn btn-sm"
                                                data-id="{{ $cl->id_judulchangelog }}"
                                                data-toggle="modal" data-target="#modal-edit-judul-changelogs">
...
<script src="{{ asset('js/page/admin/changelog.js') }}"></script>
@endpush
