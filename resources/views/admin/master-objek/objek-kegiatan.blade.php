    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Master Objek Kegiatan</div>
            </div>
        </div>
        <div class="row">
            <div class=" col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p>
                                <span class="badge alert-primary mr-2"><i class="fas fa-info"></i></span>Halaman untuk mengelola
                                Objek Kegiatan BPS Pusat.
                            </p>
                                    ...
                                    <tr id="index_{{ $objekkegiatan->kode_kegiatan }}">
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-warning edit-btn btn-sm"
                                                data-id="{{ $objekkegiatan->kode_kegiatan }}"
