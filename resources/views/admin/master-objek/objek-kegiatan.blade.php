        ...
        <section class="section">
            ...
            <div class="row">
                <div class=" col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <p class="mb-0">Halaman kelola daftar Objek Kegiatan BPS Pusat. </p>
                            ...
                            <div class="">
                                <table id="master-objek-kegiatan" class="table table-bordered display responsive">
                                    <thead>
                                        <tr>
                                            <th>Kode Kegiatan</th>
                                            <th>Satuan Kerja</th>
...
@push('scripts')
    ...
    <script src="{{ asset('js') }}/page/master-objek-kegiatan.js"></script>
@endpush
