    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Master Satuan Kerja</div>
            </div>
        </div>
        <div class="row">
            <div class=" col-md-12">
                            ...
                            <table id="master-satuan-kerja"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 100px;">Kode Wilayah</th>
                                        <th style="width: 120px;">Kode Satuan Kerja</th>
                                ...
                                <tbody>
                                    ...
                                    <tr id="index_{{ $satuankerja->id_objek }}">
                                        ...
                                        <td class="text-center">{{ $satuankerja->kode_wilayah }}</td>
                                        <td class="text-center">{{ $satuankerja->kode_satuankerja }}</td>
                                        <td>{{ $satuankerja->nama }}</td>
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-warning edit-btn btn-sm"
                                                data-id="{{ $satuankerja->id_objek }}" data-toggle="modal"
                                                data-target="#modal-edit-satuankerja">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0)" class="btn btn-danger delete-btn btn-sm"
                                                data-id="{{ $satuankerja->id_objek }}">
