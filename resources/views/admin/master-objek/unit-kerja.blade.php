...
<div class="main-content">
    ...
    @include('components.master-objek.form.create-unit-kerja');
    @include('components.master-objek.form.edit-unit-kerja');
    <section class="section">
        <div class="section-header">
            <h1>Master Unit Kerja</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/admin">Dashboard</a></div>
                <div class="breadcrumb-item">Master Unit Kerja</div>
            </div>
        </div>
        <div class="row">
            <div class=" col-md-12">
                        ...
                        <div class="d-flex justify-content-between flex-wrap my-2 mb-3" style="gap:10px">
                            ...
                            <div style="gap:10px" class="d-flex align-items-end">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#modal-create-unitkerja">
                            ...
                            <table id="master-unit-kerja" class="table table-bordered table-striped display responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 100px;">Kode Unit Kerja</th>
                                ...
                                <tbody>
                                    ...
                                    <tr id="index_{{ $unitkerja->id_objek }}">
                                        <td class="text-center">{{ $loop->iteration }}</td>
                                        <td class="text-center">{{ $unitkerja->kode_unitkerja }}</td>
                                        <td>{{ $unitkerja->nama }}</td>
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-warning edit-btn btn-sm"
                                                data-id="{{ $unitkerja->id_objek }}" data-toggle="modal"
                                                data-target="#modal-edit-unitkerja">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0)" class="btn btn-danger delete-btn btn-sm"
                                                data-id="{{ $unitkerja->id_objek }}">
