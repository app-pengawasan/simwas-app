...
@section('title', 'Master Tujuan Inspektorat Utama')
...
<div class="main-content">
    <!-- Modal -->
    @include('components.master-tujuan.create');
    @include('components.master-tujuan.edit');
    <section class="section">
        <div class="section-header">
            <h1>Master Tujuan Inspekotrat Utama</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/admin">Dashboard</a></div>
                <div class="breadcrumb-item">Master Tujuan</div>
            </div>
        </div>
        <div class="row">
            <div class=" col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <p>
                                ...
                                Halaman Mengelola Tujuan 5 Tahunan Inspektorat Utama.
                            </p>
                        ...
                        <div class="d-flex justify-content-between flex-wrap my-2 mb-3" style="gap:10px">
                            ...
                            <div style="gap:10px" class="d-flex align-items-end">
                                <button type="button" class="btn btn-primary" id="create-btn" data-toggle="modal"
                                    data-target="#modal-create-mastertujuan">
                        ...
                        <div class="">
                            <table id="master-tujuan" class="table table-bordered table-striped display responsive">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr id="index_{{ $tujuan->id_tujuan }}">
                                        <td class="text-center">{{ $loop->iteration }}</td>
                                        <td>{{ $tujuan->tahun_mulai }} - {{ $tujuan->tahun_selesai }}</td>
                                        <td>{{ $tujuan->tujuan }}</td>
                                        <td>
...
<script src="{{ asset('js/page/admin/master-tujuan.js') }}"></script>
@endpush