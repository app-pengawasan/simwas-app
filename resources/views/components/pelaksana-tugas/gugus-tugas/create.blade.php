        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label class="form-label" for="pt-jabatan">Peran</label>
                    <div class="">
                ...
                <div class="form-group">
                    <label class="form-label" style="font-weight: 600px;">Kebutuhan Jam Kerja Per Bulan
                    ...
                    <div id="month-wrap">
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-januari" class="form-control jam-kerja" name="create-januari"
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-februari" class="form-control jam-kerja"
                                name="create-februari" required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-maret" class="form-control jam-kerja" name="create-maret"
                                required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-april" class="form-control jam-kerja" name="create-april"
                                required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-mei" class="form-control jam-kerja" name="create-mei" required
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-juni" class="form-control jam-kerja" name="create-juni"
                                required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-juli" class="form-control jam-kerja" name="create-juli"
                                required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-agustus" class="form-control jam-kerja" name="create-agustus"
                                required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-september" class="form-control jam-kerja"
                                name="create-september" required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-oktober" class="form-control jam-kerja" name="create-oktober"
                                required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-november" class="form-control jam-kerja"
                                name="create-november" required style="min-width: 60px;" min="0" max="200">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" id="create-desember" class="form-control jam-kerja"
                                name="create-desember" required style="min-width: 60px;" min="0" max="200">
