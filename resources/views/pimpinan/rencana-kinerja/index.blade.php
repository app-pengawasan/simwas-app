...
<div class="main-content">
    <!-- Modal -->
    {{-- @include('components.rencana-kerja.summary-pimpinan') --}}
    <section class="section">
        <div class="section-header">
            <h1>Persetujuan Rencana Kinerja</h1>
        </div>
        <div class="row">
            <div class=" col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <p class="mb-4">
                                ...
                                Menampilkan rencana kinerja yang perlu persetujuan pimpinan.
                            </p>
...
<script src="{{ asset('js') }}/page/pegawai/persetujuan.js"></script>
@endpush
