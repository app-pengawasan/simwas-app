                                                ...
                                                <table>
                                                    @foreach ($rencanaKerja->objekPengawasan as $objek)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-warning btn-edit-objek"
                                                                    type="button" data-toggle="modal"
                                                                    data-target="#modal-edit-objek"
                                                                    data-kategori="{{ $objek->kategori_objek }}"
                                                                    data-id="{{ $objek->id_opengawasan }}"
                                                                    data-idobjek="{{ $objek->id_objek }}">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                                <button class="btn btn-danger btn-delete-objek"
                                                                    type="button" data-id="{{ $objek->id_opengawasan }}">
                                ...
                                <div class="col-md-12">
                                    @if (
                                        ($rencanaKerja->kategori_pelaksanatugas == 'gt' && count($rencanaKerja->pelaksana) > 2) ||
                                            ($rencanaKerja->kategori_pelaksanatugas == 'ngt' && count($rencanaKerja->pelaksana) > 0))
                                            ...
                                            @for ($i = 0; $i < $jumlahPelaksana; $i++)
                                                <tr>
                                                    ...
                                                    @else
                                                        ...
                                                        <td>
                                                            <button class="btn btn-warning btn-edit-pelaksana"
                                                                type="button" data-toggle="modal" data-disable=true
