                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="my-2 col-4 float-right form-group">
                                ...
                                <select class="form-control" id="filterTahun" name="filterTahun" required>
                                    <?php $year = date('Y'); ?>
                                    @for ($i = -5; $i < 8; $i++) <option value="{{ $year + $i }}">
                                        {{ $year + $i }}</option>
                                        @endfor
                                </select>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif --}}
                                        @if (count($ts->rencanaKerja->hasilKerja->masterKinerja) == 0)
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-danger disable-btn"
                                            data-id="{{ $ts->id_rencanakerja }}" style="width: 42px" data-toggle="modal"
                                            data-target="#disable-tugas">
