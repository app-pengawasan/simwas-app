...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form method="post" action="/pegawai/tim/kendali-mutu/{{ $surat->id }}" enctype="multipart/form-data">
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="/pegawai/tim/norma-hasil">Kendali Mutu</a></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4 mb-4">
                                            <a class="btn btn-primary" href="/pegawai/tim/kendali-mutu">
