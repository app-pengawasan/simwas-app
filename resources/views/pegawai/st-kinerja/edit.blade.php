                                ...
                                <form action="/pegawai/st-kinerja/{{ $usulan->id }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly
                                            class="form-control @error('tim_kerja') is-invalid @enderror" id="tim_kerja"
                                            name="tim_kerja" value="{{ old('tim_kerja') }}">
                                        @error('tim_kerja')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <select id="rencana_id" name="rencana_id"
                                            ...
                                            @foreach ($rencana_kerja as $rencana)
                                                <option value="{{ $rencana->id_rencanakerja }}"
                                                    {{ old('rencana_id', $usulan->rencana_id) == $rencana->id_rencanakerja ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" id="unit_kerja1" name="unit_kerja"
                                            value="{{ old('unit_kerja') }}">
                                        <label for="unit_kerja">Unit Kerja</label>
                                        <select disabled id="unit_kerja" name="unit_kerja"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('melaksanakan', $usulan->melaksanakan) }}">
                                        @error('melaksanakan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" id="objek1" name="objek"
                                            value="{{ old('objek') }}">
                                        <label for="objek">Objek</label>
                                        <textarea readonly style="height: 200px;" type="text" class="form-control @error('objek') is-invalid @enderror"
                                            id="objek" name="objek">{{ old('objek') }}</textarea>
                                        @error('objek')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('mulai') is-invalid @enderror"
                                            name="mulai" value="{{ old('mulai', $usulan->mulai) }}">
                                        @error('mulai')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('selesai') is-invalid @enderror"
                                            name="selesai" value="{{ old('selesai', $usulan->selesai) }}">
                                        @error('selesai')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" id="pelaksana1" name="pelaksana"
                                            value="{{ old('pelaksana') }}">
                                        <label for="pelaksana">Pelaksana Tugas</label>
                                        <textarea readonly style="height: 200px;" type="text"
                                            class="form-control @error('pelaksana') is-invalid @enderror" id="pelaksana" name="pelaksana">{{ old('pelaksana') }}</textarea>
                                        @error('pelaksana')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
