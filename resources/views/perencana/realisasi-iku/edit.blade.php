                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('realisasi-iku-unit-kerja.store') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group col">
                                        <label for="catatan">Target IKU</label>
                                        <div>
                                            <button type="button" class="btn btn-primary" id="add-objek">Lihat Target
                                                IKU</button>
                                        </div>
                                        ...
                                        <div class="form-group col">
                                            <table class="table table-responsive-md table-bordered" id="table-iku">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        <td><input disabled type="number"
                                                                name="presentase-target-triwulan1"
                                                                id="presentase-target-triwulan1" value="0"
                                                                class="form-control"></td>
                                                        <td><input disabled type="number"
                                                                name="presentase-target-triwulan2"
                                                                id="presentase-target-triwulan2" value="0"
                                                                class="form-control"></td>
                                                        <td><input disabled type="number"
                                                                name="presentase-target-triwulan3"
                                                                id="presentase-target-triwulan3" value="0"
                                                                class="form-control"></td>
                                                        <td><input disabled type="number"
                                                                name="presentase-target-triwulan4"
