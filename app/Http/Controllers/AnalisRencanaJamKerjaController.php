...
class AnalisRencanaJamKerjaController extends Controller
{
    ...
    public function rekap(Request $request)
    {
        ...
        return view('analis-sdm.rencana-jam-kerja.rekap',[
    ...
    public function pool(Request $request)
    {
        ...
        return view('analis-sdm.rencana-jam-kerja.pool',[
            'type_menu'     => 'rencana-jam-kerja',
            'unituser'      => $unituser
    ...
    public function show($id, $year)
    {
        ...
        return view('analis-sdm.rencana-jam-kerja.show',[
            'type_menu'     => 'rencana-jam-kerja',
    ...
    public function export($mode, $year, $unit)
    {
        ...
        if ($unit == null || $unit == '8000') {
            ...
            $tugas = PelaksanaTugas::where('status', 1)->whereRelation('rencanaKerja.proyek.timKerja', function (Builder $query) use ($year) {
                        $query->where('tahun', $year);
                    })->whereRelation('user', function (Builder $query) use ($unit) {
                        $query->where('unit_kerja', $unit);
                    })->groupBy('id_pegawai')->select('id_pegawai as id')
