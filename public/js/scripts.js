...
$(function () {
        ...
        if ($(".main-sidebar").length) {
            ...
            $(".main-sidebar .sidebar-menu li a.has-dropdown")
                ...
                .on("click", function () {
                    var me = $(this);
                    var active = false;
                    if (me.parent().hasClass("active-dropdown")) {
                        active = true;
                    }

                    $(
                        ".main-sidebar .sidebar-menu li.active-dropdown > .dropdown-menu"
                    ...
                    if (active == true) {
                        me.parent().removeClass("active-dropdown");
                        me.parent()
                            .find("> .dropdown-menu")
                            .slideUp(200, function () {
                                update_sidebar_nicescroll();
                        ...
                        me.parent().addClass("active-dropdown");
                        me.parent()
                            .find("> .dropdown-menu")
    ...
    if (w.outerWidth() >= 1024) {
        jQuery(function () {
            // check localstorage for mini-sidebar
